...
import { failureNotice } from "./operation-failure";
...
describe("failureNotice", () => {
	it("says nothing when the last operation did not fail", () => {
	...
	it.each(TYPES)("has an answer for a failed %s", (type) => {
	...
	it.each(["snapshot", "suspend", "unsuspend"] as BoxOperationType[])(
