...
import { SECRET_CONFIG_KEYS } from "@/convex/boxes/runtimeConfig";
...
// convex/boxes/runtimeConfig.test.ts. What this file decides is who may ask,
...
describe("saving a configuration", () => {
	...
	// `applySecretIntent`, covered in convex/boxes/runtimeConfig.test.ts. It
