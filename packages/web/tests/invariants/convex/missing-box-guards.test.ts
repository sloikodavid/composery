...
//
// `convex/boxes/lifecycle.ts` is where a workflow records what a step did. A
...
// `tests/behavior/convex/boxes/lifecycle.test.ts`, which drives every one of these
...
const source = readFileSync(
	fileURLToPath(new URL("../../../convex/boxes/lifecycle.ts", import.meta.url)),
	"utf8"
);
