...
//
// `convex/boxes/status.ts` is where a workflow records what a step did. A
...
// `tests/behavior/convex/boxes/status.test.ts`, which drives every one of these
...
const source = readFileSync(
	fileURLToPath(new URL("../../../convex/boxes/status.ts", import.meta.url)),
	"utf8"
);
