...
// place of the body.
function TableLoadingRow({ span }: { span: number }) {
	return (
		<TableRow>
			<TableCell className="h-14 text-center" colSpan={span}>
...
function TableEmptyRow({ children, span }: { children: string; span: number }) {
	return (
		<TableRow>
			<TableCell
