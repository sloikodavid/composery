...
export interface PolarIconHandle {
	startAnimation: () => void;
	stopAnimation: () => void;
}

interface PolarIconProps extends HTMLAttributes<HTMLDivElement> {
	size?: number;
}
...
const PolarIcon = forwardRef<PolarIconHandle, PolarIconProps>(
