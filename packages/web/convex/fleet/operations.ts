...
const BOX_OPERATION_PLANS = {
	create: {
		...
		workflow: internal.fleet.workflows.createBox.createBox
	},
	delete: {
		targetStatus: "deleting",
		workflow: internal.fleet.workflows.deleteBox.deleteBox
	},
	reset: {
		targetStatus: "resetting",
		workflow: internal.fleet.workflows.resetBox.resetBox
	},
	stop: {
		targetStatus: "stopping",
		workflow: internal.fleet.workflows.stopBox.stopBox
	},
	start: {
		targetStatus: "starting",
		workflow: internal.fleet.workflows.startBox.startBox
	},
	change_slug: {
		workflow: internal.fleet.workflows.changeBoxSlug.changeBoxSlug
	},
	change_password: {
		workflow: internal.fleet.workflows.changeBoxPassword.changeBoxPassword
	},
	suspend: {
		targetStatus: "suspending",
		workflow: internal.fleet.workflows.suspendBox.suspendBox
	},
	unsuspend: {
		targetStatus: "unsuspending",
		workflow: internal.fleet.workflows.unsuspendBox.unsuspendBox
	},
	restore: {
		targetStatus: "restoring",
		workflow: internal.fleet.workflows.snapshotWorkflows.restoreBox
	},
	snapshot: {
		workflow: internal.fleet.workflows.snapshotWorkflows.captureSnapshot
	},
	repair: {
		targetStatus: "repairing",
		workflow: internal.fleet.workflows.repairBox.repairBox
	},
	update: {
		targetStatus: "updating",
		workflow: internal.fleet.workflows.updateBox.updateBox
	},
	change_config: {
		workflow: internal.fleet.workflows.changeBoxConfig.changeBoxConfig
	}
} satisfies Record<
	OperationType,
...
export async function startBoxOperation(
	...
	return await ctx.runMutation(internal.fleet.operations.startOperation, {
		boxId,
