...
const convexDir = import.meta.dirname;
...
describe("Convex environment example checklist", () => {
	...
	it("finds the reads (a broken scanner would pass the equality below vacuously)", () => {
	...
	it.each([".env.example.convex.dev", ".env.example.convex.prod"])(
