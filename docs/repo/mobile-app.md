---
title: Mobile app
description: Build and ship packages/mobile-app to the App Store and Play Store.
---

`packages/mobile-app` is the Expo Router app that wraps Composery instances in a
...
Unlike [docs-website](./docs-website.md), there is no push-to-deploy. Two gates
...
3. **Expo account + project link** — from `packages/mobile-app`:
   ```bash
   npx eas-cli login
