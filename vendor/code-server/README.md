...
| `overlay/lib/vscode/out/vs/code/browser/workbench/workbench-fonts.css`  | Loads Manrope for the workbench UI and CommitMono for monospaced workbench contexts from bundled woff2 files.                       | VS Code workbench CSS  | Workbench HTML asset path, font files, or VS Code workbench font variables change upstream. |
