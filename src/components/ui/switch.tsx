...
export const switchIndicatorClassName = `${controlTransitionClassName} ${controlRadiusClassName} relative inline-flex h-4 w-7 shrink-0 cursor-pointer items-center border border-border bg-muted-surface p-px shadow-none peer-checked:border-primary peer-checked:bg-primary peer-checked:[&>span]:ms-3 peer-checked:[&>span]:bg-primary-foreground`;
